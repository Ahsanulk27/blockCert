...
import { Shield, Upload, User, GraduationCap, Calendar, FileText, Hash, CheckCircle2 } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Create tamper-proof digital certificates secured by blockchain technology.
            Perfect for educational institutions and certification bodies.
          </p>
        </div>
          ...
          <Card className="card-blockchain p-8 animate-fade-in">
            ...
            <div className="space-y-6">
              <div className="bg-primary/10 border border-primary/20 rounded-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Secure access for authorized institutions</p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Input placeholder="Institution ID" />
                  <Input placeholder="Access Code" type="password" />
                </div>
              </div>
              ...
              <p className="text-center text-sm text-muted-foreground">
                Don't have access? <a href="#" className="text-primary hover:underline">Contact us</a> for institutional registration.
              </p>
            </div>
          </Card>
        )}
        ...
        {step === 2 && (
          <Card className="card-blockchain p-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input 
                    ...
                    onChange={(e) => setCertificateData({...certificateData, course: e.target.value})}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2">Grade/Score</label>
                  <Input 
        ...
        {step === 3 && (
          <Card className="card-blockchain p-8 animate-fade-in">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-semibold">Upload Certificate</h2>
            </div>
            
            <div className="space-y-6">
              {/* File Upload */}
              <div className="border-2 border-dashed border-card-border rounded-xl p-12 text-center hover:border-accent/50 transition-colors">
                <Upload className="w-12 h-12 text-accent mx-auto mb-4" />
                <h3 className="text-lg font-medium mb-2">Upload Certificate Document</h3>
              ...
              <div className="bg-muted/20 rounded-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div><span className="font-medium">Student:</span> {certificateData.studentName || 'Not specified'}</div>
                  <div><span className="font-medium">Course:</span> {certificateData.course || 'Not specified'}</div>
                  <div><span className="font-medium">Grade:</span> {certificateData.grade || 'Not specified'}</div>
                  <div><span className="font-medium">Date:</span> {certificateData.dateIssued || 'Not specified'}</div>
                </div>
              </div>
          ...
          <Card className="card-blockchain p-8 animate-scale-in border-success/30 bg-success/5">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-8">
                Your certificate has been securely stored on the blockchain and is now available for verification.
              </p>
                ...
                <div className="bg-card p-6 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm text-left">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono text-primary">0x7d4a...9f2e</span>
                    </div>
                    <div className="flex justify-between">
