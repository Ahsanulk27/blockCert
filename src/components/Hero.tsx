...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-grid">
      ...
      <div className="absolute top-40 right-20 w-6 h-6 bg-secondary rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      <div className="absolute bottom-32 left-20 w-3 h-3 bg-accent rounded-full animate-float" style={{ animationDelay: '4s' }}></div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: '0.3s' }}>
          Revolutionary certificate issuance and verification powered by blockchain technology. 
          Ensure authenticity, prevent fraud, and build trust in digital credentials.
        </p>
        ...
        {/* Stats */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 animate-fade-in" style={{ animationDelay: '0.9s' }}>
          <div className="text-center">
            <div className="text-3xl font-bold text-primary text-glow mb-2">100%</div>
            <div className="text-muted-foreground">Tamper-Proof</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-secondary text-cyber-glow mb-2">0.3s</div>
